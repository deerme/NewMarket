...
public class OrderDAOImpl implements OrderDAO {
    ...
    public int addOrderToDatabase(final String typeOfOrder, final int quantity) {
        ...
        int autoGeneratedIdOfOrder = keyHolder.getKey().intValue();
        logger.info("Added order to database.Auto-generated id:" + autoGeneratedIdOfOrder +" Type of order"+typeOfOrder+" Quantity of order" +quantity);

        return autoGeneratedIdOfOrder;
    }
