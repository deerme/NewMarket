...
public class ExecutionManager {
    ...
    public void createExecution(Order sellOrder, Order buyOrder) throws JMSException {
        ...
        Execution execution = new Execution(buyOrder.getId(), sellOrder.getId(), buyOrder.getQuantity() , sellOrder.getQuantity() , keyWithIdOfExecution.getKey().intValue() , buyOrder.getQuantity());
