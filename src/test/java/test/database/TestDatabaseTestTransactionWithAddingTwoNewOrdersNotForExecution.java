 ...
 */
@Ignore
public class TestDatabaseTestTransactionWithAddingTwoNewOrdersNotForExecution /*extends CamelSpringTestSupport*/ {
...
//        }catch (Exception ex) {
//            Assert.assertEquals(new Integer(0),new Integer(JdbcTestUtils.countRowsInTable(jdbcTemplate,NAME_OF_TABLE_WITH_EXECUTIONS)));
